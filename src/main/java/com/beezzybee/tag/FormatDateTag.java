...
public class FormatDateTag extends TagSupport {
	...
	static {
		try {
			GET_LOCALE_METHOD = SetLocaleSupport.class.getDeclaredMethod("getFormattingLocale", PageContext.class, Tag.class, boolean.class, boolean.class);
	...
	public int doEndTag() throws JspException {
		...
		if (locale != null) {
			...
			if (this.value instanceof Date)
				formatted = this.formateDate((Date)this.value, locale);
			else if (this.value instanceof Calendar)
				formatted = this.formateDate(((Calendar)this.value).getTime(), locale);
			else if (this.value instanceof TemporalAccessor)
				formatted = this.formateDate((TemporalAccessor)this.value, locale);
			else
	...
	private String formateDate(TemporalAccessor value, Locale locale) {
		...
		return this.formateDate(dateFormat, timeFormat, value);
	}

	private String formateDate(Date value, Locale locale) {
		if (this.pattern != null) {
	...
	private <T> String formateDate(Function<T, String> dateFormat,
